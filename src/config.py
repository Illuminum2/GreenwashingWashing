...
PLAYWRIGHT_LOADED_EVENT = "networkidle" # 'load': Extract DOM when JS load event is triggered; 'networkidle': Extract DOM when network connections are idle for >500ms 
